    ...
    return function e(t, r, n) {
        ...
        1: [function(e, t, r) {
            ...
            t.exports = function(e, t, r) {
                e = a(e),
                    (r = r || {}).summary_text = r.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + t + '" target="blank">@' + t + "</a>",
                !1 === r.global_stats && (e.style.minHeight = "175px"),
                    r.proxy = r.proxy || function(e) {
                ...
                return function s() {
                    return fetch(r.proxy("https://github.com/" + t)).then(function(e) {
                        ...
                        if (c.querySelector(".float-left.text-gray").innerHTML = r.summary_text,
                            ...
                            if (!0 === r.responsive) {
                                ...
                                l.removeAttribute("height"),
                                    ...
                                    l.setAttribute("viewBox", "0 0 " + d + " " + f)
                            }
                            if (!1 !== r.global_stats) {
                                var p = n(a("svg", c).outerHTML)
                                    , b = p.current_streak ? u(p.current_streak_range[0], "MMMM D") + " – " + u(p.current_streak_range[1], "MMMM D") : p.last_contributed ? "Last contributed in " + u(p.last_contributed, "MMMM D") + "." : "Rock - Hard Place"
                                    , m = p.longest_streak ? u(p.longest_streak_range[0], "MMMM D") + " – " + u(p.longest_streak_range[1], "MMMM D") : p.last_contributed ? "Last contributed in " + u(p.last_contributed, "MMMM D") + "." : "Rock - Hard Place"
                                    , g = a("<div>", {
        ...
        4: [function(e, t, r) {
            function n(e, t) {
                return "string" == typeof e ? "<" === e.charAt(0) ? (e = document.createElement(e.slice(1, -1)),
                    a(t || {}, function(t, r) {
                        switch (r) {
                            case "text":
            ...
            var a = e("iterate-object")
                , o = e("sliced");
            n.$$ = function(e, t) {
                return "string" == typeof e ? (t = t || document,
                    o(t.querySelectorAll(e))) : [e]
            }
                ,
                t.exports = n
        }
        ...
        8: [function(e, t, r) {
            ...
            t.exports = function(e) {
                var t = {
                    ...
                    , r = []
                    , a = function() {
                    t.current_streak > t.longest_streak && (t.longest_streak = t.current_streak,
                ...
                return e.split("\n").slice(2).map(function(e) {
                    ...
                    if (e.startsWith("<g transform"))
                        return r.length && t.weeks.push(r) && (r = []);
                    ...
                    if (o = o && o[1],
                        ...
                        0 === t.current_streak && (t.current_streak_range[0] = i.date),
                            i.count ? (++t.current_streak,
                                t.last_year += i.count,
                                t.last_contributed = i.date,
                                t.current_streak_range[1] = i.date) : (a(),
                                t.current_streak = 0),
                            r.push(i),
                            t.days.push(i)
                    }
        ...
        11: [function(e, t, r) {
            ...
            var o = function() {
                ...
                function e(t) {
                    n(this, e),
                        this.obj = t || {},
                        this.re = new RegExp("^(" + Object.keys(t).map(u).join("|") + ")")
                }
                return o(e, [{
                    key: "run",
                    value: function(e, t) {
                        ...
                        do {
                            ...
                            if (a) {
                                var u = this.obj[a];
                                "function" == typeof u && (u = u.apply(this, t)),
                                    r += u
                            } else
                                r += o;
