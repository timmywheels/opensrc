                                ...
                                <div className={ "col-lg-3 col-md-4 col-sm-6 card-block" } key={ key }>
                                    <div className={ "card" }>
                                        <div className={ 'card-body d-flex flex-column' }>
                                            <div className={ 'row' }>
                                                <a className={ 'repo-link col-9' } href={ repo.html_url }
                                                   target="_blank"
                                                   rel="noopener noreferrer">
                                                    <h5 className={ 'card-title' }>{ repo.name }</h5>
                                                </a>
                                                <p className="fork-link col-3"><img src={ GitHubFork }
                                                                                    alt="GitHub Fork Icon"/>{ repo.forks }
                                                </p>
                                            </div>
                                            <p className={ 'card-text' }>{ repo.description }</p>
                                            <img className="language-img" src={ repoLanguageImg }
